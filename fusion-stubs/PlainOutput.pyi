...
class PlainOutput:
	...
	def GetDoD(self, time: int | None = None, flags: int | None = None, proxy: int | None = None) -> list[int] | None:
		"""
	...
	def GetValue(self, time: int | None = None, flags: int | None = None, proxy: int | None = None) -> Parameter | dict[Any, Any]:
		"""
