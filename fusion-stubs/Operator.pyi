...
class Operator:
    ...
    def AddLayerInput(self, name: str, id: str, inp: Input, tags: TagList) -> Input:
        ...
    ...
    def GetBaseLayerName(self, req: Request) -> str:
        ...
    ...
    def ProcessLayer(self, req: Request, layer: str) -> bool:
        ...
    ...
    def _SetProcessLayerDefault(self, mode: str, tags: TagList) -> None:
        ...
