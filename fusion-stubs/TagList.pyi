...
class TagList:
    ...
    def _Get_int64(self, tag: Tag, def_: int) -> int:
        ...

    def _Get_uint32(self, tag: Tag, def_: int) -> int:
        ...

    def _Get_uint64(self, tag: Tag, def_: int) -> int:
        ...
    ...
    def _Set_int64(self, tag: Tag, val: int, addnew: bool) -> None:
        ...

    def _Set_uint32(self, tag: Tag, val: int, addnew: bool) -> None:
        ...

    def _Set_uint64(self, tag: Tag, val: int, addnew: bool) -> None:
        ...
